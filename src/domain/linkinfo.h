...
struct LinkInfo
{
    ...
    // Referencias internas de InDesign. Nos permitirán identificar
    // posteriormente tanto el enlace como el elemento gráfico que lo contiene.
    ...
    // Información adicional en caso de que el enlace no pueda procesarse normalmente.
