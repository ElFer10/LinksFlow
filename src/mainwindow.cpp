...
connect(
    ...
    [this]()
    {
        ...
        link1.fileName =
            QStringLiteral("portada.psd");
        link1.filePath =
            QStringLiteral(
                "/Proyecto/Links/portada.psd"
            );
        link1.fileType =
            QStringLiteral("PSD");
        link1.fileSizeBytes =
        ...
        link1.colorMode =
            QStringLiteral("CMYK");
        link1.iccProfile =
            QStringLiteral("Coated FOGRA39");
        link1.actualResolution =
            {300.0, 300.0};
        link1.effectiveResolution =
            {1130.0, 962.0};
        link1.scale =
            {26.55, 31.19};
        link1.rotation = 0.0;
        ...
        link2.fileName =
            QStringLiteral("producto.tif");
        link2.filePath =
            QStringLiteral(
                "/Proyecto/Links/producto.tif"
            );
        link2.fileType =
            QStringLiteral("TIFF");
        link2.fileSizeBytes =
        ...
        link2.actualResolution =
            {300.0, 300.0};
        link2.effectiveResolution =
            {600.0, 600.0};
        link2.scale =
            {50.0, 50.0};
        link2.rotation = 0.0;
        ...
        link3.fileName =
            QStringLiteral("fondo.jpg");
        link3.filePath =
            QStringLiteral(
                "/Proyecto/Links/fondo.jpg"
            );
        link3.fileType =
            QStringLiteral("JPEG");
        link3.fileSizeBytes =
        ...
        link3.actualResolution =
            {300.0, 300.0};
        link3.effectiveResolution =
            {240.0, 240.0};
        link3.scale =
            {125.0, 125.0};
        link3.rotation = 12.5;
        ...
        link4.fileName =
            QStringLiteral("missing.psd");
        link4.filePath =
            QStringLiteral(
                "/Proyecto/Links/missing.psd"
            );
        link4.fileType =
            QStringLiteral("PSD");
        link4.state =
            LinkProcessState::Missing;
        link4.statusMessage =
            QStringLiteral(
